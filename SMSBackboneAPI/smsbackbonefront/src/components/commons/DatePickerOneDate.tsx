...
const DatePickerOneDate: React.FC<DatePickerProps> = ({
  ...
  // Si viene initialDate la usamos, si no, hoy
  ...
  const [focusedDate, setFocusedDate] = useState<Date>(initialDate ?? new Date());
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      <div style={{ position: 'relative' }}>
                        ...
                        <div style={{
                          ...
                          <button
                            onClick={() => unit.setter((prev) => (prev + 1) % (i === 0 ? 24 : 60))}
                            style={{ border: 'none', background: 'none', cursor: 'pointer' }}
                          >
                            <img src={Iconarrow} alt="Subir" style={{ width: '12px', height: '12px' }} />
                          </button>
                          <button
                            onClick={() => unit.setter((prev) => (prev - 1 + (i === 0 ? 24 : 60)) % (i === 0 ? 24 : 60))}
                            style={{ border: 'none', background: 'none', cursor: 'pointer' }}
                          >
